...
--
-- Table structure for table `predicts_predictrequest`
--

DROP TABLE IF EXISTS `predicts_predictrequest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `predicts_predictrequest` (
  ...
  CONSTRAINT `predicts_predictrequ_dashboard_id_94b01beb_fk_predicts_` FOREIGN KEY (`dashboard_id`) REFERENCES `predicts_dashboard` (`id`),
