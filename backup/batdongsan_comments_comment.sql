...
CREATE TABLE `comments_comment` (
  ...
  CONSTRAINT `comments_comment_answer_id_026b1302_fk_comments_comment_id` FOREIGN KEY (`answer_id`) REFERENCES `comments_comment` (`id`),
  CONSTRAINT `comments_comment_article_id_94fe60a2_fk_news_newsarticle_id` FOREIGN KEY (`article_id`) REFERENCES `news_newsarticle` (`id`),
